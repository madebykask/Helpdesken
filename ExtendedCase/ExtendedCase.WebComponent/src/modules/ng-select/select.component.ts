import { Component, HostListener, Input, OnChanges, OnInit, Output, EventEmitter, ExistingProvider, ViewChild, ViewEncapsulation, forwardRef, ElementRef, SimpleChange, SimpleChanges, ContentChild, TemplateRef, ChangeDetectionStrategy, ChangeDetectorRef } from '@angular/core';
...
export class SelectComponent implements ControlValueAccessor, OnChanges, OnInit {
    ...
    @ViewChild('selection', {static: false}) selectionSpan: ElementRef;
