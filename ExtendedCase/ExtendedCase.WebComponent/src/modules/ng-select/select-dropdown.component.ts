import { AfterViewInit, Component, EventEmitter, Input, OnChanges, OnInit, Output, ViewChild, TemplateRef, ViewEncapsulation, ChangeDetectorRef, ChangeDetectionStrategy } from '@angular/core';
...
implements AfterViewInit, OnChanges, OnInit {
    ...
    trackById(index: any, item: Option) {
        return item.value;
    }
