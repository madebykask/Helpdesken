     ...
     tabs: [{
          ...
          sections: [
          {
            ...
            ////////////////////////////////////////// sec1 //////////////////////////////////////
            {
               ...
               disabledStateAction: "ClearOnUserOnly",       // Clear, Keep, RestorePrev, ClearOnUserOnly    
               //disabledStateActionCondition: "Any", // UserOnly|Any                  
               
               disabledBinding: function(m, l){
               ...
               dataSources: [
                    ...
                    //customers for selected user
                    {
                        type: "query",			
                        id: "customersByUserQuery",
                        parameters: [{ name: "userId", field: "tabs.tab1.sections.sec1.instances[%index%].controls.usersDropDown1"}]            
                    },
               ],
              ...
              //multi
               ...
               //customers for selected user
               {
                    ...
                    valueBinding: function(m, log){
                        //debugger;
                        var self = this;
                        var res = log.logs.some(function(el, index){ 
                                    return el.multiId == self.parent.controls.usersDropDown1.multiId;
                                  });
                        if (res)
                        {
                            var ds = this.parent.dataSources.customersByUserQuery;                            
                            var customer= ds && ds.length > 0 ? ds.length[0] : "";
                            console.log("@@@ usersDropdown has been changed! @@@");
                        }
                        return this.value;
                    },
                    //>>>> Section datasource!
               ...
               {    
                  ...
                  disabledBinding:  function(m, log) {         
                  //debugger;         
                  var userId = this.parent.controls.usersDropDown1.value || "";
                  var customerId = this.parent.controls.customerDropDown1.value || "";
                  ...
                  dataSource: {											
				    type: "option",
				    id: "RegionsByCustomerSample",
				    parameters: [
                              { name: "UserId", field: "tabs.tab1.sections.sec1.instances[%index%].controls.usersDropDown1" },
						{ name: "CustomerId", field: "tabs.tab1.sections.sec1.instances[%index%].controls.customerDropDown1"}								
                       ]
                  }
               },
