...
BEGIN
    ...
    -- Declare variables for batching
    DECLARE @BatchSize INT = 100; -- Set batch size (adjust as needed)
    ...
    -- Perform deletes in batches to avoid long-running transactions
    WHILE @ProcessedCount < @TotalCount
    BEGIN
        -- Begin a transaction for the current batch
        BEGIN TRANSACTION;
        ...
        BEGIN TRY
            ...
            BEGIN
                DELETE TOP (@BatchSize) lu WITH (ROWLOCK)
            ...
            IF (OBJECT_ID ('tblLink_tblWorkingGroup', 'U') IS NOT NULL AND 
                ...
                OBJECT_ID ('tblChange', 'U') IS NOT NULL)
            BEGIN
                DELETE TOP (@BatchSize) lw WITH (ROWLOCK)
			...
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cl WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblParentChildCaseRelations', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) tpr WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCase_ExtendedCaseData', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) tec WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseIsAbout', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) tca WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseQuestion', 'U') IS NOT NULL  AND 
			...
			BEGIN
				DELETE TOP (@BatchSize) cq WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseQuestionCategory', 'U') IS NOT NULL  AND 
			OBJECT_ID ('tblCaseQuestionHeader', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cqc WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseQuestionHeader', 'U') IS NOT NULL)
			BEGIN
 				DELETE TOP (@BatchSize) cqh WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblLogFileExisting', 'U') IS NOT NULL  AND 
			...
			BEGIN
 				DELETE TOP (@BatchSize) lfe WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblLogFileExisting', 'U') IS NOT NULL  AND 
			OBJECT_ID ('tblLog', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cd WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblChange_tblChangeGroup', 'U') IS NOT NULL  AND 
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) ccg WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseInvoiceRow', 'U') IS NOT NULL  AND 
			...
			BEGIN
	 			DELETE TOP (@BatchSize) cir WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblChangeCouncil', 'U') IS NOT NULL  AND 
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cc WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblChange_tblChange', 'U') IS NOT NULL  AND 
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cch WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblChangeFile', 'U') IS NOT NULL  AND 
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cf WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblLog', 'U') IS NOT NULL AND 
			...
			BEGIN
				DELETE TOP (@BatchSize) lf WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblLog', 'U') IS NOT NULL AND 
			...
			BEGIN
				DELETE TOP (@BatchSize) m2t WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblLog', 'U') IS NOT NULL AND 
			...
			BEGIN
				DELETE TOP (@BatchSize) m2tc WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblLog', 'U') IS NOT NULL AND 
			...
			BEGIN
				DELETE TOP (@BatchSize) ela WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseHistory', 'U') IS NOT NULL AND 
			OBJECT_ID ('tblEmailLog', 'U') IS NOT NULL)
			BEGIN			
				DELETE TOP (@BatchSize) el WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblInvoiceRow', 'U') IS NOT NULL AND 
			OBJECT_ID ('tblLog', 'U') IS NOT NULL)
			BEGIN	
				DELETE TOP (@BatchSize) tl WITH (ROWLOCK)
				FROM tblLog AS tl
				INNER JOIN tblInvoiceRow AS ir
		...
		IF (OBJECT_ID ('tblInvoiceRow', 'U') IS NOT NULL)
			BEGIN	
				DELETE TOP (@BatchSize) ir WITH (ROWLOCK)
				FROM tblInvoiceRow AS ir
				INNER JOIN @Cases AS c
					ON ir.Case_Id = c.Id;
			END
		...
		IF (OBJECT_ID ('tblInvoiceRow', 'U') IS NOT NULL AND 
			OBJECT_ID ('tblInvoiceHeader', 'U') IS NOT NULL)
			BEGIN	
				DELETE TOP (@BatchSize) ih WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseHistory', 'U') IS NOT NULL)
			BEGIN	
				DELETE TOP (@BatchSize) ch WITH (ROWLOCK)
				FROM tblCaseHistory AS ch
		...
		IF (OBJECT_ID ('tblFileViewLog', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) fvl WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseInvoiceArticle', 'U') IS NOT NULL AND 
			...
			BEGIN
				DELETE TOP (@BatchSize) cia WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseInvoiceOrderFile', 'U') IS NOT NULL AND 
			...
			OBJECT_ID ('tblCaseInvoice', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cof WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseInvoiceOrder', 'U') IS NOT NULL AND 
			OBJECT_ID ('tblCaseInvoice', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cio WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseInvoice', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) ci WITH (ROWLOCK)
				FROM tblCaseInvoice AS ci
				INNER JOIN #TmpCaseInvoice AS t
					ON t.Id = ci.Id;
			END
		...
		IF (OBJECT_ID ('tblCaseSolutionSchedule', 'U') IS NOT NULL AND 
			...
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) csc WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseSolutionFieldSettings', 'U') IS NOT NULL AND 
			...
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) csf WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblLink', 'U') IS NOT NULL AND 
			...
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
 				DELETE TOP (@BatchSize) l WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseSolution_tblCaseSection_ExtendedCaseForm', 'U') IS NOT NULL AND 
			...
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cse WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseSolutionConditionLog', 'U') IS NOT NULL AND 
			...
			OBJECT_ID ('tblChange', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cscl WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseFollowUps', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) flu WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseExtraFollowers', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) ef WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCase_tblCaseSection_ExtendedCaseData', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) tecd WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblQuestionnaireCircularPart', 'U') IS NOT NULL AND 
			...
			BEGIN
				DELETE TOP (@BatchSize) qqr WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblQuestionnaireCircularPart', 'U') IS NOT NULL AND 
			...
			BEGIN
				DELETE TOP (@BatchSize) qr WITH (ROWLOCK)
				FROM tblQuestionnaireResult AS qr			
				INNER JOIN #TmpQuestionnaireCircularPart AS cp
					ON qr.QuestionnaireCircularPartic_Id = cp.Id;
			END
		...
		IF (OBJECT_ID ('tblQuestionnaireCircularPart', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cp WITH (ROWLOCK)
				FROM tblQuestionnaireCircularPart AS cp
		...
		IF (OBJECT_ID ('tblMergedCases', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) mc WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblLogProgram', 'U') IS NOT NULL)
			BEGIN
				DELETE lp 
				FROM tblLogProgram AS lp WITH (ROWLOCK)
				INNER JOIN @Cases AS c
					ON c.Id = lp.Case_Id;
			END
		...
		IF (OBJECT_ID ('tblLocalAdmin', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) la WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblFormFieldValueHistory', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) vh WITH (ROWLOCK) 
		...
		IF (OBJECT_ID ('tblFormFieldValue', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) tfv WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCaseStatistics', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cs WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblChecklistRow', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) cr WITH (ROWLOCK)
		...
		IF (OBJECT_ID ('tblCase', 'U') IS NOT NULL)
			BEGIN
				DELETE TOP (@BatchSize) tc WITH (ROWLOCK)
				FROM tblCase AS tc
				INNER JOIN  @Cases AS c
					ON tc.Id = c.Id;
			END

            -- Commit the current transaction after successful deletions
            COMMIT TRANSACTION;
        ...
        END TRY
        BEGIN CATCH
            -- In case of an error, roll back the current transaction
            IF @@TRANCOUNT > 0
            BEGIN
                ROLLBACK TRANSACTION;
            END

            -- Throw the error back for further handling
    ...
    -- Drop temporary tables at the end (if any were created)
