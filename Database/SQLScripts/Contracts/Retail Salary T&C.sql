...
-- #################################### Footer
INSERT INTO tblCaseDocument_CaseDocumentParagraph(CaseDocument_Id, CaseDocumentParagraph_Id, SortOrder)
SELECT @retSalTcID, @footerID, @counter
SET @counter = @counter + 1
...
INSERT INTO tblCaseDocument_CaseDocumentParagraph(CaseDocument_Id, CaseDocumentParagraph_Id, SortOrder)
SELECT @retSalTcID, @addressInfoID, @counter
SET @counter = @counter + 1
...
DECLARE @retSalTcEmployGreetingTextBGuid UNIQUEIDENTIFIER = 'A2D4D098-BC76-411C-8288-B6EE279E1DA9',
	@retSalTcEmployGreetingTextBName NVARCHAR(MAX) = @prefix + ' Greeting, Part time',
	@retSalTcEmployGreetingTextBDescription NVARCHAR(MAX) = '',
	@retSalTcEmployGreetingTextBText NVARCHAR(MAX) = 'We are delighted to confirm that your application for the position of Part Time <Position Title (Local Job Name)> <Shift Type> Shift has been successful, and wish to confirm the terms and conditions of your employment.',
	@retSalTcEmployGreetingTextBHeadline NVARCHAR(MAX) = '',
	@retSalTcEmployGreetingTextBSortOrder INT = 1
...
DECLARE @retSalTcEmployGreetingTextBCondAGuid UNIQUEIDENTIFIER = '03D3DBF6-F7CA-4B79-93CC-1B31EA68D624',
	@retSalTcEmployGreetingTextBCondAPropertyName NVARCHAR(MAX) = 'extendedcase_ContractedHours',
	@retSalTcEmployGreetingTextBCondAOperator NVARCHAR(MAX) = 'LessThan',
	@retSalTcEmployGreetingTextBCondAValues NVARCHAR(MAX) = '76',
	@retSalTcEmployGreetingTextBCondADescription NVARCHAR(MAX) = 'Is part time',
...
DECLARE @retSalTcTermsPositionAGuid UNIQUEIDENTIFIER = '413683D9-1521-45A6-9687-6C65CA7CC698',
	@retSalTcTermsPositionAName NVARCHAR(MAX) = @prefix + ' Employment - Position - Full time',
	@retSalTcTermsPositionADescription NVARCHAR(MAX) = '',
	@retSalTcTermsPositionAText NVARCHAR(MAX) = 'Your position is Full Time <Position Title (Local Job Name)> <Shift Type> Shift, reporting to  <Position Title (Local Job Name)> of <Reports To Line Manager>, which will be based at <Business Unit>. Your position (in terms of your duties & responsibilities), and location may be varied from time to time in accordance with IKEA’s needs.',
...
DECLARE @retSalTcTermsPositionBGuid UNIQUEIDENTIFIER = '186EFA0E-BEA7-432E-BB73-4D48229D20DA',
	...
	@retSalTcTermsPositionBText NVARCHAR(MAX) = 'Your position is Part Time <Position Title (Local Job Name)> <Shift Type> Shift, reporting to  <Position Title (Local Job Name)> of <Reports To Line Manager>, which will be based at <Business Unit>. Your position (in terms of your duties & responsibilities), and location may be varied from time to time in accordance with IKEA’s needs.',
...
DECLARE @retSalTcTermsComAGuid UNIQUEIDENTIFIER = '9B15024D-F436-4923-978C-25E6FCDAD07D',
	@retSalTcTermsComAName NVARCHAR(MAX) = @prefix + ' Employment - Commencement - No date',
	@retSalTcTermsComADescription NVARCHAR(MAX) = '',
	@retSalTcTermsComAText NVARCHAR(MAX) = 'Your commencement date is <Contract Start Date>, unless otherwise terminated in accordance with this contract.',
...
DECLARE @retSalTcTermsComACondAGuid UNIQUEIDENTIFIER = '3334A6E7-0949-49F0-9BD0-F16C0DE402F3',
	@retSalTcTermsComACondAPropertyName NVARCHAR(MAX) = 'extendedcase_ContractEndDate',
	@retSalTcTermsComACondAOperator NVARCHAR(MAX) = 'IsEmpty',
	@retSalTcTermsComACondAValues NVARCHAR(MAX) = '',
	@retSalTcTermsComACondADescription NVARCHAR(MAX) = 'Has no end date',
...
DECLARE @retSalTcTermsComBGuid UNIQUEIDENTIFIER = '6B40FCB6-78AE-4ECF-B644-546030FA2FCF',
	@retSalTcTermsComBName NVARCHAR(MAX) = @prefix + ' - Commencement - Has end date',
	@retSalTcTermsComBDescription NVARCHAR(MAX) = '',
	@retSalTcTermsComBText NVARCHAR(MAX) = 'Your commencement date is <Contract Start Date> and will cease on <Contract End Date>, unless otherwise terminated in accordance with this contract.',
...
DECLARE @retSalTcTermsComBCondAGuid UNIQUEIDENTIFIER = '0F77A915-6609-4F1F-91CA-570B509456FF',
	@retSalTcTermsComBCondAPropertyName NVARCHAR(MAX) = 'extendedcase_ContractEndDate',
	@retSalTcTermsComBCondAOperator NVARCHAR(MAX) = 'HasValue',
	@retSalTcTermsComBCondAValues NVARCHAR(MAX) = '',
	@retSalTcTermsComBCondADescription NVARCHAR(MAX) = 'Has end date',
...
DECLARE @retSalTcTermsHWAGuid UNIQUEIDENTIFIER = '45296772-BE49-4A2C-95BD-5521A6017F23',
	@retSalTcTermsHWAName NVARCHAR(MAX) = @prefix + ' - Hours of Work - Full time',
...
-- #################################### Remuneration
DECLARE @retSalTcTermsRemunGuid UNIQUEIDENTIFIER = '07CA3A13-244D-48F9-AE29-073E7EB4CB30',
	@retSalTcTermsRemunName NVARCHAR(MAX) = @prefix + ' - Remuneration',
	@retSalTcTermsRemunDescription NVARCHAR(MAX) = '',
	@retSalTcTermsRemunText NVARCHAR(MAX) = 'Upon commencement, your base hourly rate will be as per the <b>IKEA Distributions Services Australia Pty Ltd Enterprise Agreement 2016</b>.  This amount will be paid directly into your nominated bank account on a fortnightly basis.',
...
DECLARE @retSalTcTermsSuperGuid UNIQUEIDENTIFIER = '7CAC3B64-8051-4D84-A9E2-3713C981A795',
	...
	@retSalTcTermsSuperText NVARCHAR(MAX) = 'IKEA will make superannuation contributions, on your behalf, to a government approved Superannuation Fund, at the rate payable under the Superannuation Guarantee Legislation (SGL). This rate is currently 9.5% of your wage.
<br>
...
DECLARE @retSalTcTermsLeaveAGuid UNIQUEIDENTIFIER = '4A91E33B-4E5E-457F-97DC-67E70D94305A',
	...
	@retSalTcTermsLeaveAText NVARCHAR(MAX) = 'From your commencement date, you are entitled to leave in accordance with the relevant legislation and the IKEA Distribution Services Australia Pty Ltd Enterprise Agreement 2016. These entitlements are processed as detailed in the IKEA policies.',
...
DECLARE @retSalTcTermsLeaveBGuid UNIQUEIDENTIFIER = '8E0507DC-CCA3-49C9-A6C2-CE95D2793B5D',
	...
	@retSalTcTermsLeaveBText NVARCHAR(MAX) = 'You will accrue entitlements to leave in accordance with relevant legislation and company policy on a pro rata basis (compared to a full-time employee). As stated in the IKEA Distribution Services Australia Pty Ltd Enterprise Agreement 2016.  These entitlements are processed as detailed in the IKEA policies.  This includes personal leave, annual leave, parental leave and long service leave.',
...
-- #################################### Uniform & Conduct
DECLARE @retSalTcTermsUniformGuid UNIQUEIDENTIFIER = '03609F36-C253-44F4-9D83-2A49E19132AA',
	@retSalTcTermsUniformName NVARCHAR(MAX) = @prefix + ' - Uniform & Conduct',
	@retSalTcTermsUniformDescription NVARCHAR(MAX) = '',
	@retSalTcTermsUniformText NVARCHAR(MAX) = 'IKEA has established guidelines necessary for the professional appearance that IKEA expects all co-workers to present, and as such co-workers are supplied with uniforms and name badges within these guidelines.
<br><br>
Co-workers are expected to project a favourable and professional image for IKEA, and are to be courteous, efficient and reliable in their dealings with colleagues, existing and potential customers and suppliers to IKEA.',
	@retSalTcTermsUniformHeadline NVARCHAR(MAX) = 'Uniform & Conduct',
	@retSalTcTermsUniformSortOrder INT = @termsCounter
SET @termsCounter = @termsCounter + 1

IF NOT EXISTS (SELECT * FROM tblCaseDocumentText CDT WHERE  CDT.CaseDocumentTextGUID = @retSalTcTermsUniformGuid)
BEGIN
	INSERT INTO tblCaseDocumentText(CaseDocumentParagraph_Id, [Name], [Description], [Text],[Headline], SortOrder, CaseDocumentTextGUID)
	VALUES (@retSalTcTermsID, 
		@retSalTcTermsUniformName, 
		@retSalTcTermsUniformDescription,
		@retSalTcTermsUniformText, 
		@retSalTcTermsUniformHeadline,
		@retSalTcTermsUniformSortOrder,
		@retSalTcTermsUniformGuid)
END
ELSE
BEGIN
	UPDATE CDT SET 
		CaseDocumentParagraph_Id = @retSalTcTermsID,
		[Name] = @retSalTcTermsUniformName, 
		[Description] = @retSalTcTermsUniformDescription, 
		[Text] = @retSalTcTermsUniformText,
		[Headline] = @retSalTcTermsUniformHeadline,
		SortOrder = @retSalTcTermsUniformSortOrder
	FROM tblCaseDocumentText CDT 
	WHERE CDT.CaseDocumentTextGUID = @retSalTcTermsUniformGuid
END
...
-- #################################### 24 Termination
DECLARE @retSalTcTermsTerminationGuid UNIQUEIDENTIFIER = 'E746A64C-7812-4918-AE8D-6A714A96C259',
	@retSalTcTermsTerminationName NVARCHAR(MAX) = @prefix + ' - Termination',
	@retSalTcTermsTerminationDescription NVARCHAR(MAX) = '',
	@retSalTcTermsTerminationText NVARCHAR(MAX) = 'Either party may terminate the employment relationship with the appropriate notice as prescribed in the IKEA Distribution Services Australia Pty Ltd Enterprise Agreement 2016.  Notice provisions do not apply in the case of summary dismissal.
<br><br>
...
IKEA reserves the right to withhold an appropriate sum of money from a co-worker’s termination payment until such time as any outstanding company property as detailed above is returned.',
	@retSalTcTermsTerminationHeadline NVARCHAR(MAX) = 'Termination',
	@retSalTcTermsTerminationSortOrder INT = @termsCounter
SET @termsCounter = @termsCounter + 1

IF NOT EXISTS (SELECT * FROM tblCaseDocumentText CDT WHERE  CDT.CaseDocumentTextGUID = @retSalTcTermsTerminationGuid)
BEGIN
	INSERT INTO tblCaseDocumentText(CaseDocumentParagraph_Id, [Name], [Description], [Text],[Headline], SortOrder, CaseDocumentTextGUID)
	VALUES (@retSalTcTermsID, 
		@retSalTcTermsTerminationName, 
		@retSalTcTermsTerminationDescription,
		@retSalTcTermsTerminationText, 
		@retSalTcTermsTerminationHeadline,
		@retSalTcTermsTerminationSortOrder,
		@retSalTcTermsTerminationGuid)
END
ELSE
BEGIN
	UPDATE CDT SET 
		CaseDocumentParagraph_Id = @retSalTcTermsID,
		[Name] = @retSalTcTermsTerminationName, 
		[Description] = @retSalTcTermsTerminationDescription, 
		[Text] = @retSalTcTermsTerminationText,
		[Headline] = @retSalTcTermsTerminationHeadline,
		SortOrder = @retSalTcTermsTerminationSortOrder 
	FROM tblCaseDocumentText CDT 
	WHERE CDT.CaseDocumentTextGUID = @retSalTcTermsTerminationGuid
END
...
DECLARE @retSalTcTermsPoliciesGuid UNIQUEIDENTIFIER = 'F1AFE56F-D2C1-4705-B38C-BECDB46717B0',
	...
	@retSalTcTermsPoliciesText NVARCHAR(MAX) = 'You shall be required to comply with all IKEA Policies and Procedures as amended from time to time and as outlined in IKEA’s Policy Guidelines and Welcome Program. The IKEA Policies and Procedures form part of your contract of employment.',
...
DECLARE @retSalTcTermsPoliceGuid UNIQUEIDENTIFIER = 'FF449CCC-36BE-4B8A-97F1-A8D9E7B495BF',
	...
	@retSalTcTermsPoliceText NVARCHAR(MAX) = 'Some positions at IKEA require evidence of good character (for example - positions that deal with children or cash).  Obtaining details of your criminal history via a police check/s is an integral part of the assessment of your suitability for such positions.
<br><br>
...
DECLARE @retSalTcTermsPerfGuid UNIQUEIDENTIFIER = '8C18311C-BE0F-4DE6-9030-DB1D66659E70',
	@retSalTcTermsPerfName NVARCHAR(MAX) = @prefix + ' - Performance',
	@retSalTcTermsPerfDescription NVARCHAR(MAX) = '',
	@retSalTcTermsPerfText NVARCHAR(MAX) = 'A Co-worker Performance Review will be conducted at least once a year, usually between September and November.  However, your first review will be conducted during your 6-month probationary period.  This review will be based on your initial Co-worker discussion and your position’s Performance Criteria and Job Profile.  Areas of performance and non-performance will be discussed and addressed in accordance with company guidelines. Whilst the company conducts annual performance reviews, it also maintains an ongoing performance management program with its co-workers.',
	@retSalTcTermsPerfHeadline NVARCHAR(MAX) = 'Performance Management',
	@retSalTcTermsPerfSortOrder INT = @termsCounter
SET @termsCounter = @termsCounter + 1

IF NOT EXISTS (SELECT * FROM tblCaseDocumentText CDT WHERE  CDT.CaseDocumentTextGUID = @retSalTcTermsPerfGuid)
BEGIN
	INSERT INTO tblCaseDocumentText(CaseDocumentParagraph_Id, [Name], [Description], [Text],[Headline], SortOrder, CaseDocumentTextGUID)
	VALUES (@retSalTcTermsID, 
		@retSalTcTermsPerfName, 
		@retSalTcTermsPerfDescription,
		@retSalTcTermsPerfText, 
		@retSalTcTermsPerfHeadline,
		@retSalTcTermsPerfSortOrder,
		@retSalTcTermsPerfGuid)
END
ELSE
BEGIN
	UPDATE CDT SET 
		CaseDocumentParagraph_Id = @retSalTcTermsID,
		[Name] = @retSalTcTermsPerfName, 
		[Description] = @retSalTcTermsPerfDescription, 
		[Text] = @retSalTcTermsPerfText,
		[Headline] = @retSalTcTermsPerfHeadline,
		SortOrder = @retSalTcTermsPerfSortOrder
	FROM tblCaseDocumentText CDT 
	WHERE CDT.CaseDocumentTextGUID = @retSalTcTermsPerfGuid
END
...
DECLARE @retSalTcTermsMediaGuid UNIQUEIDENTIFIER = '1F791297-DDEA-443B-BCA4-73FADC2079EF',
	...
	@retSalTcTermsMediaText NVARCHAR(MAX) = 'You shall not provide information or speak on behalf of IKEA or otherwise to the media on any matters concerning IKEA’s business or activities.  You must refer all requests from the media for information and/or interviews to the DC Manager.',
...
DECLARE @retSalTcTermsVarGuid UNIQUEIDENTIFIER = 'F6DAD77B-F1AA-4DB3-B7BE-3DF045BA39EA',
	...
	@retSalTcTermsVarText NVARCHAR(MAX) = 'This Agreement may only be varied by a written agreement signed by yourself and IKEA.',
...
DECLARE @retSalTcTermsSuspGuid UNIQUEIDENTIFIER = 'AF8CCD89-989F-4537-83A1-7D56E205CCEE',
	...
	@retSalTcTermsSuspText NVARCHAR(MAX) = 'If we have reason to believe that you may have engaged in a serious breach of your employment obligations, IKEA may at its discretion suspend you from your duties, either with or without pay, while and investigation is conducted.',
