...
BEGIN TRAN
	...
	SELECT BU.BU_TK, BU.CLT_CLASS, BU.CLU_CODE, BU.CLUT_TYPE, BU.[NAME], BU.NAME_SHORT, BU.Created, BU.Exported 
	...
	SELECT BU.CLUT_TYPE + ' ' + BU.CLU_CODE, 
          @customerID, 
          CASE WHEN LEN(BU.[NAME] + ' (' + BU.CLUT_TYPE + ' ' + BU.CLU_CODE + ')') > 49
          THEN
