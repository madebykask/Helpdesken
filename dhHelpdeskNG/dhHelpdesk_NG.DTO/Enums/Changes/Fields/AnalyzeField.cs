namespace DH.Helpdesk.BusinessData.Enums.Changes.Fields
{
    public static class AnalyzeField
    {
        ...
        public static readonly string EstimatedTimeInHours = "Analyze.EstimatedTimeInHours";
        ...
        public static readonly string HasImplementationPlan = "Analyze.HasImplementationPlan";
