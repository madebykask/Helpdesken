namespace DH.Helpdesk.BusinessData.Models.Inventory.Output.Computer
{
    ...
    {
        public ContractFieldsSettings(int? contractStatusId, string contractNumber, DateTime contractStartDate, DateTime contractEndDate, int purchasePrice, string accountingDimension1, string accountingDimension2, string accountingDimension3, string accountingDimension4, string accountingDimension5)
        {
