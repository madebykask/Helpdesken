	...
	$.fn.fixheadertable = function(options) {
		...
		return this.each(function() {
			...
			function restrictRows(table, nbrows) {
				...
				_nbpagesDiv.html( _currentpage + ' / ' + _nbpages);
			...
			if(options.wrapper){
				...
				var tampon = _wrapper.wrap('<div class="ui-widget ui-widget-content ui-corner-all" style="padding : 0; font-size : 1em;"></div>').parent();
