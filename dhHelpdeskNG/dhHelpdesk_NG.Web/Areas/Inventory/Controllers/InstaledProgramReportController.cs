namespace DH.Helpdesk.Web.Areas.Inventory.Controllers
{
    ...
    public class InstaledProgramReportController : ComputerModuleReportBaseController
    {
        public InstaledProgramReportController(
        ...
        public override ReportTypes ReportType
        {
            get
            {
                return ReportTypes.InstaledPrograms;
            }
        }

        protected override List<ReportModel> GetComputerReportModels(int? departmentId, string searchFor)
        {
            return this.ComputerModulesService.GetComputersInstaledSoftware(
        ...
        {
            return this.ComputerModulesService.GetServersInstaledSoftware(
                SessionFacade.CurrentCustomer.Id,
                searchFor);
        }
