namespace DH.Helpdesk.Web.Areas.Inventory.Controllers
{
    ...
    public class ProcessorReportController : ComputerModuleReportBaseController
    {
        public ProcessorReportController(
        ...
        {
            return this.ComputerModulesService.GetConnectedToServersProcessorsOverviews(
                SessionFacade.CurrentCustomer.Id,
                searchFor);
        }
