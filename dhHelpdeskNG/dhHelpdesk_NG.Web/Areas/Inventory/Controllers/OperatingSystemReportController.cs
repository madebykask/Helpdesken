namespace DH.Helpdesk.Web.Areas.Inventory.Controllers
{
    ...
    public class OperatingSystemReportController : ComputerModuleReportBaseController
    {
        public OperatingSystemReportController(
        ...
        public override ReportTypes ReportType
        {
            get
            {
                return ReportTypes.OperatingSystem;
            }
        }
