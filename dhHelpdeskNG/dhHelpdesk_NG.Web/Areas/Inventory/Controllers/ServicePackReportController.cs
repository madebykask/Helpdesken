namespace DH.Helpdesk.Web.Areas.Inventory.Controllers
{
    ...
    public class ServicePackReportController : ComputerModuleReportBaseController
    {
        public ServicePackReportController(
        ...
        public override ReportTypes ReportType
        {
            get
            {
                return ReportTypes.ServicePack;
            }
        }
        ...
        {
            return this.ComputerModulesService.GetConnectedToServerServicePackOverviews(
                SessionFacade.CurrentCustomer.Id,
                searchFor);
        }
