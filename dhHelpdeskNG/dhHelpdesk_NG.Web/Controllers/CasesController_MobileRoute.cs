...
namespace DH.Helpdesk.Web.Controllers
{
    public partial class CasesController : BaseController
	{
		...
		public ActionResult R(int id)
        {
			...
			var setting = _settingService.GetCustomerSetting(@case.CustomerId);
			var globalSettings = _globalSettingService.GetGlobalSettings().Single();
		...
		{
			// Code from: http://detectmobilebrowsers.com/ seems to work
			// Alternative future use (more fail proof?): https://www.nuget.org/packages/DeviceDetector.NET/ but requires .NET Core 2.0
