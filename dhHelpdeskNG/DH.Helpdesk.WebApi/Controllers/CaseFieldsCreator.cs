...
namespace DH.Helpdesk.WebApi.Controllers
{
    public interface ICaseFieldsCreator
    {
        void CreateInitiatorSection(int cid, CustomerUser customerUserSetting,  
            IList<CaseFieldSetting> caseFieldSettings, ReadOnlyCollection<CaseSolutionSettingOverview> caseTemplateSettings,
        ...
        void CreateRegardingSection(int cid, IList<CaseFieldSetting> caseFieldSettings, ReadOnlyCollection<CaseSolutionSettingOverview> caseTemplateSettings,
        ...
        void CreateComputerInfoSection(int cid, IList<CaseFieldSetting> caseFieldSettings, ReadOnlyCollection<CaseSolutionSettingOverview> caseTemplateSettings,
            Case currentCase, CaseSolution template, int languageId,
            IList<CaseFieldSettingsForTranslation> caseFieldTranslations, CaseEditOutputModel model);

        void CreateCaseInfoSection(int cid, IList<CaseFieldSetting> caseFieldSettings, ReadOnlyCollection<CaseSolutionSettingOverview> caseTemplateSettings,
            Case currentCase, CaseSolution template, int languageId,
        ...
        void CreateCommunicationSection(int cid, UserOverview currentUserOverview, IList<CaseFieldSetting> caseFieldSettings,
            ReadOnlyCollection<CaseSolutionSettingOverview> caseTemplateSettings, Case currentCase, CaseSolution template,
    ...
    public class CaseFieldsCreator : ICaseFieldsCreator
    {
        ...
        public CaseFieldsCreator(ICaseFileService caseFileService, ICaseFieldSettingsHelper caseFieldSettingsHelper,
            ...
            ICaseTranslationService caseTranslationService, IDepartmentService departmentService, IPriorityService priorityService,
            IWatchDateCalendarService watchDateCalendarService, ICaseTypeService caseTypeService, IProductAreaService productAreaService)
        {
            ...
            CaseDefaultsInfo customerDefaults = null)
        {
            ...
            if (customerUserSetting.UserInfoPermission.ToBool())
            {
                ...
                {
                    var regionId = currentCase != null ? currentCase.Region_Id : template?.Region_Id ?? customerDefaults.RegionId;
        ...
        public void CreateRegardingSection(int cid, IList<CaseFieldSetting> caseFieldSettings, ReadOnlyCollection<CaseSolutionSettingOverview> caseTemplateSettings,
            Case currentCase, CaseSolution template, int languageId,
            IList<CaseFieldSettingsForTranslation> caseFieldTranslations, CaseEditOutputModel model)
        {
            IBaseCaseField field;
        ...
        public void CreateComputerInfoSection(int cid, IList<CaseFieldSetting> caseFieldSettings, ReadOnlyCollection<CaseSolutionSettingOverview> caseTemplateSettings,
            Case currentCase, CaseSolution template, int languageId,
            IList<CaseFieldSettingsForTranslation> caseFieldTranslations, CaseEditOutputModel model)
        {
        ...
        public void CreateCaseInfoSection(int cid, IList<CaseFieldSetting> caseFieldSettings, ReadOnlyCollection<CaseSolutionSettingOverview> caseTemplateSettings,
            Case currentCase, CaseSolution template, int languageId,
            IList<CaseFieldSettingsForTranslation> caseFieldTranslations, CaseEditOutputModel model, CustomerUser customerUserSetting, 
            CaseDefaultsInfo customerDefaults = null)
        {
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.CaseNumber) && currentCase != null)
            {
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.RegTime) && currentCase != null)
            {
                field = GetField(currentCase != null ? DateTime.SpecifyKind(currentCase.RegTime, DateTimeKind.Utc) : DateTime.UtcNow, cid, languageId,
                    CaseFieldsNamesApi.RegTime, GlobalEnums.TranslationCaseFields.RegTime, CaseSectionType.CaseInfo,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }

            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.ChangeTime) && currentCase != null)
            {
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.User_Id) && currentCase != null)
            {
                var userIdValue = "";
            ...
            {
                var caseTypeId = currentCase != null ? currentCase.CaseType_Id : template?.CaseType_Id ?? customerDefaults.CaseTypeId;
            ...
            {
                var supplierId = currentCase != null ? currentCase.Supplier_Id : template?.Supplier_Id ?? customerDefaults.SupplierId;
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.ContactBeforeAction))
            {
                field = new BaseCaseField<bool>()
                {
                    ...
                    Value = currentCase?.ContactBeforeAction.ToBool() ?? template?.ContactBeforeAction.ToBool() ?? false,
            ...
            if ( /*customerSettings.AttachmentPlacement == 1 &&*/
                _caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.Filename))
            {
            ...
            CaseDefaultsInfo customerDefaults = null)
        {
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.WorkingGroup_Id))
            {
                ...
                field = GetField(workingGroupId, cid, languageId,
                    CaseFieldsNamesApi.WorkingGroupId, GlobalEnums.TranslationCaseFields.WorkingGroup_Id, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }
            ...
            {
                var caseResponsibleUserId = currentCase != null ? currentCase.CaseResponsibleUser_Id : currentUserOverview.Id;
                field = GetField(caseResponsibleUserId, cid, languageId,
                    CaseFieldsNamesApi.CaseResponsibleUserId, GlobalEnums.TranslationCaseFields.CaseResponsibleUser_Id, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.Performer_User_Id))
            {
                ...
                if (currentCase == null && template == null)
                    performerId = customerSettings.SetUserToAdministrator ? currentUserOverview.Id : customerSettings.DefaultAdministratorId;
                else
                {
                ...
                field = GetField(performerId, cid, languageId,
                    CaseFieldsNamesApi.PerformerUserId, GlobalEnums.TranslationCaseFields.Performer_User_Id, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }
            ...
            {
                var priorityId = currentCase != null ? currentCase.Priority_Id : template?.Priority_Id ?? customerDefaults.SupplierId;
                // Set working group from the product area working group if was not set before for New case only
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.Status_Id))
            {
                ...
                field = GetField(statusId, cid, languageId,
                    CaseFieldsNamesApi.StatusId, GlobalEnums.TranslationCaseFields.Status_Id, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }
            ...
            if (customerSettings.ModuleProject &&
                _caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.Project))
            {
                field = new BaseCaseField<int?>()
                {
            ...
            if (customerSettings.ModuleProblem &&
                _caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.Problem))
            {
                field = GetField(currentCase != null ? currentCase.Problem_Id : template?.Problem_Id, cid, languageId,
                    CaseFieldsNamesApi.Problem, GlobalEnums.TranslationCaseFields.Problem, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.CausingPart))
            {
                field = GetField(currentCase != null ? currentCase.CausingPartId : template?.CausingPartId, cid, languageId,
                    CaseFieldsNamesApi.CausingPart, GlobalEnums.TranslationCaseFields.CausingPart, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.PlanDate))
            {
                field = GetField(currentCase != null ?
                        ...
                        template?.PlanDate != null ? DateTime.SpecifyKind(template.PlanDate.Value, DateTimeKind.Utc) : new DateTime?(),
                    cid, languageId,
                    CaseFieldsNamesApi.PlanDate, GlobalEnums.TranslationCaseFields.PlanDate, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.WatchDate))
            {
                var watchDate = currentCase != null ?
                    ...
                    template?.WatchDate != null ? DateTime.SpecifyKind(template.WatchDate.Value, DateTimeKind.Utc) : new DateTime?();
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.Verified))
            {
                field = GetField(currentCase?.Verified.ToBool() ?? template?.Verified.ToBool(), cid, languageId,
                    CaseFieldsNamesApi.Verified, GlobalEnums.TranslationCaseFields.Verified, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.VerifiedDescription))
            {
                field = GetField(currentCase != null ? currentCase.VerifiedDescription : template?.VerifiedDescription, cid, languageId,
                    CaseFieldsNamesApi.VerifiedDescription, GlobalEnums.TranslationCaseFields.VerifiedDescription, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
            ...
            if (_caseFieldSettingsHelper.IsActive(caseFieldSettings, caseTemplateSettings, GlobalEnums.TranslationCaseFields.SolutionRate))
            {
                field = GetField(currentCase != null ? currentCase.SolutionRate : template?.SolutionRate, cid, languageId,
                    CaseFieldsNamesApi.SolutionRate, GlobalEnums.TranslationCaseFields.SolutionRate, CaseSectionType.CaseManagement,
                    caseFieldSettings, caseFieldTranslations);
                model.Fields.Add(field);
            }
        }

        public void CreateCommunicationSection(int cid, UserOverview userOverview, IList<CaseFieldSetting> caseFieldSettings,
            ReadOnlyCollection<CaseSolutionSettingOverview> caseTemplateSettings, Case currentCase, CaseSolution template,
            int languageId, IList<CaseFieldSettingsForTranslation> caseFieldTranslations, CaseEditOutputModel model)
        {
