...
namespace upKeeper2Helpdesk.api
{
	public class BaseAPI
	{
		...
		public IEnumerable<IDictionary<string, string>> GetComputerNames(Token t)
		{
		...
		public Computer GetComputer(string ComputerId, Token t)
		{
			Computer c = null;
		...
		public ComputerDetail GetComputerDetail(string ComputerId, Token t)
		{
			//var client = new RestClient(_BaseUrl + "/api/68/ComputerDetail/" + ComputerId); //When connecting against UpKeeper test account
			var client = new RestClient(_BaseUrl + "/api/1/ComputerDetail/" + ComputerId);
            var request = new RestRequest(Method.GET);
		...
		public string GetComputerByName(string Name, Token t)
		{
			//var client = new RestClient(_BaseUrl + "/api/68/ComputerByName/" + Name); //When connecting against UpKeeper test account
			var client = new RestClient(_BaseUrl + "/api/1/ComputerByName/" + Name);
            var request = new RestRequest(Method.GET);
			request.AddHeader("cache-control", "no-cache");
			request.AddHeader("Authorization", "Bearer " + t.Access_token);
			IRestResponse response = client.Execute(request);
		...
		public Hardware GetHardware(string ComputerId, Token t)
		{
		...
		public List<Software> GetComputerSoftware(string ComputerId, Token t)
		{
		...
		public List<Hotfix> GetComputerUpdates(string ComputerId, Token t)
		{
		...
		public string SaveComputerDetails(string Id, ComputerDetail cd, Token t)
		{
            try
            {
				//var client = new RestClient(_BaseUrl + "/api/68/Computer/" + Id); //When connecting against UpKeeper test account
				var client = new RestClient(_BaseUrl + "/api/1/Computer/" + Id);
		...
		public void DeleteComputer(string Id, Token t)
		{
			//var client = new RestClient(_BaseUrl + "/api/68/Computer/" + Id); //When connecting against UpKeeper test account
			var client = new RestClient(_BaseUrl + "/api/1/Computer/" + Id);
