    ...
    public static class CaseMapper
    {
                                           ...
                                           int userId)
        {
            var entities = customers.Select(customer => new
            {
                ...
                CasesInRest = customer.Cases.Where(c => c.FinishingDate == null && c.StateSecondary_Id != null && c.StateSecondary.IncludeInCaseStatistics == 0 && c.Deleted == 0).Count(),
