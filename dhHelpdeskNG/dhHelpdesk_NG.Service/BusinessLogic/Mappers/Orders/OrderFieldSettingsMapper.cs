namespace DH.Helpdesk.Services.BusinessLogic.Mappers.Orders
{
    ...
    public static class OrderFieldSettingsMapper
    {
        ...
        public static OrdersFieldSettingsOverview MapToOrdersFieldSettingsOverview(this IQueryable<OrderFieldSettings> query)
        {
        ...
        private static OrdersFieldSettingsOverview CreateFieldSettingsOverview(NamedObjectCollection<OrdersFieldSettingsOverviewMapData> fieldSettings)
        {
            ...
            return new OrdersFieldSettingsOverview(
                                                delivery,
                                                general,
                                                log,
                                                orderer,
