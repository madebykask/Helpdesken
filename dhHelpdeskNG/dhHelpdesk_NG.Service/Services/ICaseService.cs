...
namespace DH.Helpdesk.Services.Services
{
    public interface ICaseService
    {
        ...
        void SendMergedCaseEmail(Case mergedCase, Case mergeParent, CaseMailSetting cms, int caseHistoryId, TimeZoneInfo userTimeZone, CaseLog caseLog, List<string> followers);
    }
}
