...
namespace dhHelpdesk_NG.Service
{
    ...
    public class DepartmentService : IDepartmentService
    {
        ...
        {
            return _departmentRepository.GetMany(x => x.Customer_Id == customerId && x.IsActive == isActive).OrderBy(x => x.DepartmentName).ToList();
        }
        ...
        {
            return _departmentRepository.Get(x => x.Id == id);
        }
