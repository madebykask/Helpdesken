...
//            TempData["oldValues"] = oldHidden;
            ...
            var html = RenderRazorViewToString("~/FormLibContent/Areas/Ireland/Views/Absences/Pdfs/" + id + ".cshtml", model, false);
        ...
        private IrelandPdfPage GetPdfPage(int customerId, string searchKey, string language, string id, string absenceNr, Department department,FormModel model)
        {
