...
namespace DH.Helpdesk.EForm.FormLib.Areas.UnitedKingdom.Controllers
{
    public class AdditionalPaymentsDeductionController : FormLib.Controllers.FormLibBaseController
    {
        ...
        public ActionResult Contract(string id, int caseId, string path, string allowanceNr)
        {
            ...
            var html = RenderRazorViewToString("~/FormLibContent/Areas/UnitedKingdom/Views/AdditionalPaymentsDeduction/Pdfs/" + id + ".cshtml", model, false);
        ...
        private UnitedKingdomPdfPage GetPdfPage(int customerId, string searchKey, string language, string id, string multiNr, Department department, FormModel model)
        {
