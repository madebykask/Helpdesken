...
{
    public class LeaveAndAbsenceController : FormLibBaseController
    {
        public const string xmlPath = "poland/leaveandabsence.xml";

       private readonly IContractRepository _contractRepository;
        private readonly IFileService _fileService;

        public LeaveAndAbsenceController(IContractRepository contractRepository
