...
{
    public class NoShowController : FormLibBaseController
    {
        public const string xmlPath = "poland/noshow.xml";

        private readonly IContractRepository _contractRepository;
        private readonly IFileService _fileService;

        public NoShowController(IContractRepository contractRepository
