...
{
    public class TerminationController : FormLibBaseController
    {
        public const string xmlPath = "poland/termination.xml";

        private readonly IContractRepository _contractRepository;
        private readonly IFileService _fileService;

        public TerminationController(IContractRepository contractRepository
