...
{
    public class MassRequestLeaveAndAbsenceController : BaseController
    {
        private readonly IContractRepository _contractRepository;

        public MassRequestLeaveAndAbsenceController(IContractRepository contractRepository
        ...
        public ActionResult New(FormCollection formCollection, string[] uploads)
        {
            ...
            dictionary.Add("EmployeeNumber", "00000000");
