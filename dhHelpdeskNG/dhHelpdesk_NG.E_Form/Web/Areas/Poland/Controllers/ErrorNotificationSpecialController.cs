...
{
    public class ErrorNotificationSpecialController : BaseController
    {
        private readonly IContractRepository _contractRepository;
        private readonly IFileService _fileService;

        public ErrorNotificationSpecialController(IContractRepository contractRepository
        ...
        public ActionResult New(FormCollection formCollection, string[] uploads)
        {
            ...
            if(model.IsValid(ref dictionary, 11))
            {
