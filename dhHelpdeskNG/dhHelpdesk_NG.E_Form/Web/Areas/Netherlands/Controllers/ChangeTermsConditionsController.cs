    ...
    public class ChangeTermsConditionsController : BaseController
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            if (contract.Company != null)
                model.SetAnswer("Department", contract.Company.Key);
            if (contract.Unit != null)
                model.SetAnswer("BusinessUnit", contract.Unit.Key);

            //if (contract.EmployeeNumber == null)
            //{
            //    model.SetAnswer("IKEAEmailAddress", contract.HelpdeskEMail);
            //}
