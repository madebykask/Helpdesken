...
using DH.Helpdesk.CaseSolutionScheduleYearly.Infrastructure.Cache;
using DH.Helpdesk.CaseSolutionScheduleYearly.Infrastructure.Context;
using DH.Helpdesk.CaseSolutionScheduleYearly.Infrastructure.Translate;
...
namespace DH.Helpdesk.CaseSolutionScheduleYearly.DI.Modules
{
    public class ServiceModule : NinjectModule
    {
        public override void Load()
        {
            ...
            Bind<IFormFieldRepository>().To<FormFieldRepository>();
            //IFormFieldValueRepository
            Bind<IFormFieldValueRepository>().To<FormFieldValueRepository>();
            //ICaseSolutionConditionRepository
            Bind<ICaseSolutionConditionRepository>().To<CaseSolutionConditionRepository>();
            //IEntityToBusinessModelMapper
            Bind<IEntityToBusinessModelMapper<CaseSolutionCondition, CaseSolutionConditionOverview>>();
            //IBusinessModelToEntityMapper{CaseSolutionConditionModel, CaseSolutionConditionEntity}
            ...
            // Fix for CS0311: Ensure the correct types are used in the binding
