...
#pragma warning restore 0618
            Bind<IDatabaseFactory>().To<DatabaseFactory>().WithConstructorArgument("connectionString", _connectionString);
            Bind<ISessionFactory>().To<HelpdeskSessionFactory>().WithConstructorArgument("connectionString", _connectionString);
