    ...
    public class NewOrderModelFactory : INewOrderModelFactory
    {
            ...
            OrderUserData userContext, bool createCaseFromOrder, int customerId, int? orderTypeId, IGlobalSettingService globalSettingService)
        {
            ...
            return new FullOrderEditModel(
                ...
                CreateUserEditModel(data.EditSettings, userContext),
                CreateUserInfoEditModel(data.EditSettings, data.EditOptions),
                temporatyId,
                customerId,
                orderTypeId,
                true,
        ...
        {
            var userId = _configurableFieldModelFactory.CreateStringField(settings.User.UserId, userContext.Login);
            var userFirstName = _configurableFieldModelFactory.CreateStringField(settings.User.UserFirstName, userContext.FirstName);
            var userLastName = _configurableFieldModelFactory.CreateStringField(settings.User.UserLastName, userContext.LastName);
            var userPhone = _configurableFieldModelFactory.CreateStringField(settings.User.UserPhone, userContext.Phone);
            var userEmail = _configurableFieldModelFactory.CreateStringField(settings.User.UserEMail, userContext.Email);
