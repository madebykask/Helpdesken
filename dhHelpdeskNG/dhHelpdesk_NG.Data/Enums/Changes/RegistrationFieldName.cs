...
{
    public static class RegistrationFieldName
    {
        ...
        public static readonly string ProcessAffected = "tblChange_tblChangeGroup";

        public static readonly string DepartmentAffected = "tblChange_tblDepartment";
        ...
        public static readonly string AttachedFile = "Filename";

        public static readonly string Approval = "ApprovalDate";

        public static readonly string Explanation = "ChangeExplanation";
    }
}
