namespace DH.Helpdesk.Dal.Mappers.Inventory.EntityToBusinessModel.Server
{
    ...
    public sealed class ServerFieldSettingsToServerOverviewSettingsMapper :
        IEntityToBusinessModelMapper<NamedObjectCollection<FieldOverviewSettingMapperData>, ServerFieldsSettingsOverview>
    {
        public ServerFieldsSettingsOverview Map(NamedObjectCollection<FieldOverviewSettingMapperData> entity)
        {
            ...
            var settings = new ServerFieldsSettingsOverview(
                general,
                other,
                state,
                storage,
        ...
        private static GeneralFieldsSettings CreateGeneralSettings(NamedObjectCollection<FieldOverviewSettingMapperData> entity)
        {
        ...
        private static StorageFieldsSettings CreateStorageSettings(NamedObjectCollection<FieldOverviewSettingMapperData> entity)
        {
