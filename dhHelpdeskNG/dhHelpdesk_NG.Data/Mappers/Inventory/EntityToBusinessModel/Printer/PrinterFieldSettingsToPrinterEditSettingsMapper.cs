namespace DH.Helpdesk.Dal.Mappers.Inventory.EntityToBusinessModel.Printer
{
    ...
    using GeneralFieldsSettings = DH.Helpdesk.BusinessData.Models.Inventory.Output.Settings.ModelEdit.PrinterSettings.GeneralFieldsSettings;
    using OrganizationFields = DH.Helpdesk.Dal.Enums.Inventory.Printer.OrganizationFields;
    using OrganizationFieldsSettings = DH.Helpdesk.BusinessData.Models.Inventory.Output.Settings.ModelEdit.PrinterSettings.OrganizationFieldsSettings;
    using OtherFields = DH.Helpdesk.Dal.Enums.Inventory.Printer.OtherFields;
    using OtherFieldsSettings = DH.Helpdesk.BusinessData.Models.Inventory.Output.Settings.ModelEdit.PrinterSettings.OtherFieldsSettings;
    ...
    using StateFieldsSettings = DH.Helpdesk.BusinessData.Models.Inventory.Output.Settings.ModelEdit.PrinterSettings.StateFieldsSettings;

    public sealed class PrinterFieldSettingsToPrinterEditSettingsMapper :
        IEntityToBusinessModelMapper<NamedObjectCollection<FieldSettingMapperDataForModelEdit>, PrinterFieldsSettingsForModelEdit>
    {
        public PrinterFieldsSettingsForModelEdit Map(NamedObjectCollection<FieldSettingMapperDataForModelEdit> entity)
        {
            ...
            var settings = new PrinterFieldsSettingsForModelEdit(
                general,
                inventory,
                communication,
                other,
        ...
        private static GeneralFieldsSettings CreateWorkstationSettings(NamedObjectCollection<FieldSettingMapperDataForModelEdit> entity)
        {
        ...
        private static StateFieldsSettings CreateStateSettings(NamedObjectCollection<FieldSettingMapperDataForModelEdit> entity)
        {
            ...
            var syncChangedDate = CreateFieldSetting(entity.FindByName(StateFields.SyncDate));

            var settings = new StateFieldsSettings(createdDate, changedDate, syncChangedDate);
            return settings;
        }
