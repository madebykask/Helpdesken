namespace DH.Helpdesk.Dal.Mappers.Inventory.EntityToBusinessModel.Computer
{
    ...
    using CommunicationFieldsSettings = DH.Helpdesk.BusinessData.Models.Inventory.Output.Settings.ModelEdit.ComputerSettings.CommunicationFieldsSettings;
    using PlaceFields = DH.Helpdesk.Dal.Enums.Inventory.Computer.PlaceFields;
    using PlaceFieldsSettings = DH.Helpdesk.BusinessData.Models.Inventory.Output.Settings.ModelEdit.ComputerSettings.PlaceFieldsSettings;

    public sealed class ComputerFieldSettingsToComputerEditSettingsMapper :
        IEntityToBusinessModelMapper<NamedObjectCollection<FieldSettingMapperDataForModelEdit>, ComputerFieldsSettingsForModelEdit>
    {
        public ComputerFieldsSettingsForModelEdit Map(NamedObjectCollection<FieldSettingMapperDataForModelEdit> entity)
        {
            ...
            var settings = new ComputerFieldsSettingsForModelEdit(
                date,
                communication,
                contact,
                contactInformation,
        ...
        private static GraphicsFieldsSettings CreateGraphicsSettings(NamedObjectCollection<FieldSettingMapperDataForModelEdit> entity)
        {
        ...
        private static SoundFieldsSettings CreateSoundSettings(NamedObjectCollection<FieldSettingMapperDataForModelEdit> entity)
        {
        ...
        private static ContractFieldsSettings CreateContractSettings(NamedObjectCollection<FieldSettingMapperDataForModelEdit> entity)
        {
        ...
        private static ContactFieldsSettings CreateContactSettings(NamedObjectCollection<FieldSettingMapperDataForModelEdit> entity)
        {
        ...
        private static DateFieldsSettings CreateDateSettings(NamedObjectCollection<FieldSettingMapperDataForModelEdit> entity)
        {
