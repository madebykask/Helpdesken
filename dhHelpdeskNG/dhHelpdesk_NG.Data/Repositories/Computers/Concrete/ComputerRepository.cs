            ...
            if (!string.IsNullOrEmpty(searchFor))
            {
                ...
                query =
                    query.Where(
						...
						|| c.BarCode.ToLower().Contains(pharseInLowerCase)
						//|| c.Building.ToLower().Contains(pharseInLowerCase)
						|| c.ChassisType.ToLower().Contains(pharseInLowerCase)
						|| c.ContractNumber.ToLower().Contains(pharseInLowerCase)
						//|| c.Floor.ToLower().Contains(pharseInLowerCase)
						|| c.IPAddress.ToLower().Contains(pharseInLowerCase)
						|| c.Location2.ToLower().Contains(pharseInLowerCase)
						|| c.LocationAddress.ToLower().Contains(pharseInLowerCase)
						|| c.LocationPostalAddress.ToLower().Contains(pharseInLowerCase)
						|| c.LocationPostalCode.ToLower().Contains(pharseInLowerCase)
						|| c.LocationAddress.ToLower().Contains(pharseInLowerCase)
						|| c.MACAddress.ToLower().Contains(pharseInLowerCase)
						|| c.NovellClient.ToLower().Contains(pharseInLowerCase)
						|| (c.OS != null && c.OS.Name.ToLower().Contains(pharseInLowerCase))
						|| (c.Processor != null && c.Processor.Name.ToLower().Contains(pharseInLowerCase))
						|| (c.RAM != null && c.RAM.Name.ToLower().Contains(pharseInLowerCase))
						|| c.ReplacedWithComputerName.ToLower().Contains(pharseInLowerCase)
						|| (c.Room != null && c.Room.Name.ToLower().Contains(pharseInLowerCase))
						|| c.SoundCard.ToLower().Contains(pharseInLowerCase)
						|| c.SP.ToLower().Contains(pharseInLowerCase)
						|| c.Info.ToLower().Contains(pharseInLowerCase)
						|| c.Location.ToLower().Contains(pharseInLowerCase)
						|| c.LocationRoom.ToLower().Contains(pharseInLowerCase)
						|| (c.OU != null && c.OU.Name.ToLower().Contains(pharseInLowerCase))
						|| c.VideoCard.ToLower().Contains(pharseInLowerCase)
						);
            }
