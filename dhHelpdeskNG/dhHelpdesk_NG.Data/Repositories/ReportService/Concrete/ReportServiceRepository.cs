                ...
                if (filters.SelectedWorkingGroups.Any())
                {
                    if (filters.SelectedWorkingGroups.Contains(0))
                    {
                        if (filters.SelectedWorkingGroups.Count == 1)
                            ...
                            _whereStr += string.Format("AND (tblCase.WorkingGroup_Id in ({0}) || tblCase.WorkingGroup_Id is null) ", filters.SelectedWorkingGroups.GetSelectedStr().SafeForSqlInject());
                    }
                    else
