...
{    
    ...
    internal sealed class CaseDocumentConditionConfiguration : EntityTypeConfiguration<CaseDocumentConditionEntity>
    {
        #region Constructors and Destructors

        internal CaseDocumentConditionConfiguration()
        {
            HasKey(e => e.Id);
            Property(e => e.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            Property(e => e.CaseDocument_Id).IsRequired();
            Property(e => e.CaseDocumentConditionGUID).IsRequired().HasDatabaseGeneratedOption(DatabaseGeneratedOption.Computed);
            ...
            ToTable("tblCaseDocumentCondition");
        }
