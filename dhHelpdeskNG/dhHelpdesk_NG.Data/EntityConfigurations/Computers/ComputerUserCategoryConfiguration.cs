...
namespace DH.Helpdesk.Dal.EntityConfigurations.Computers
{
	public sealed class ComputerUserCategoryConfiguration : EntityTypeConfiguration<ComputerUserCategory>
	{
		internal ComputerUserCategoryConfiguration()
		{
			...
			this.HasOptional(o => o.CaseSolution).WithMany().HasForeignKey(o => o.CaseSolutionID).WillCascadeOnDelete(false);
			...
			this.HasOptional(o => o.ExtendedCaseForm).WithMany().HasForeignKey(o => o.ExtendedCaseFormID).WillCascadeOnDelete(false);
