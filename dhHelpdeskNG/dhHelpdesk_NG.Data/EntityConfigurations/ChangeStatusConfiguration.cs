namespace DH.Helpdesk.Dal.EntityConfigurations
{
    ...
    public class ChangeStatusConfiguration : EntityTypeConfiguration<ChangeStatusEntity>
    {
        internal ChangeStatusConfiguration()
        {
            ...
            this.Property(x => x.CompletionStatus).IsRequired();
            this.Property(x => x.Customer_Id).IsRequired();
            this.Property(x => x.InformOrderer).IsRequired();
            this.Property(x => x.IsDefault).IsRequired().HasColumnName("isDefault");
            this.Property(x => x.Name).IsRequired().HasMaxLength(50).HasColumnName("ChangeStatus");
